terraform {
  backend "s3" {
    ...
    key            = "github/jacksonporter/wordpress-on-eks/infra/live/example-account/environments/dev/services/wordpress/terraform.tfstate" # change this to use your GitHub (or other) repository path and account name
